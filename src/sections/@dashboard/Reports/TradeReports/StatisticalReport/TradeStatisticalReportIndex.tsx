...
import { TradeStatisticalReportPrintView } from './TradeStatisticalReportPrintView';
import { IExpenseReportParam } from 'src/@types/foamCompanyTypes/ExpenseReports';

// ----------------------------------------------------------------------

export default observer(function TradeStatisticalReportIndex() {
  const { commonDropdown, TradeReportsStore } = useStore();
  ...
  const { loadTradeStatisticalReport, TradeStatisticalReportDetails } = TradeReportsStore;
  ...
  useEffect(() => {}, [TradeStatisticalReportDetails]);

  const Search = (e: any) => {
    e.preventDefault();
    setFilterButtonClicked(!filterButtonClicked);
    setIsloading(true);
    loadTradeStatisticalReport({
      branchIds: branch,
        ...
        <Grid container>
              ...
              <>
                ...
                <Stack direction="row" spacing={1.5} sx={{ mt: 3 }}>
                  ...
                  <Button
                    ...
                    onClick={() => {
                      TradeStatisticalReportDetails!.report!.length = 0;
                      setFilterButtonClicked(!filterButtonClicked);
          ...
          <Grid item xs={9} md={8} sx={{}}>
            {isloading ? (
              ...
              <TradeStatisticalReportPrintView
                ref={componentRef}
                // bothSide={bothSide}
                filterButtonClicked={filterButtonClicked}
                StatisticalReportDetails={TradeStatisticalReportDetails}
              />
            )}
          </Grid>
        </Grid>
